...
const config = {
  ...
  ANTI_DELETE: process.env.ANTI_DELETE !== undefined ? process.env.ANTI_DELETE === "true" : false, // Enabled
  ...
  AUTO_RECORDING: process.env.AUTO_RECORDING !== undefined ? process.env.AUTO_RECORDING === "true" : false, // Enabled
  ...
  MODE: process.env.MODE || "private", // Enabled
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "+27648968508",
